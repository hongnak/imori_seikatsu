...
class EditImoriumPage extends StatelessWidget {
  const EditImoriumPage({Key? key, required this.imorium}) : super(key: key);
  final Imorium imorium;

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<EditImoriumModel>(
      create: (_) => EditImoriumModel(imorium: imorium)..fetchData(),
      child: Scaffold(
        appBar: AppBar(title: Text('${imorium.name}を編集')),
